...
BOT_NAME = getenv("BOT_NAME" , "𝐃𝐉 ꭙ ᴍᴜsɪᴄ˼ ㋛︎ ♪ [ ʙ4ᴜ ]™")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/dwlumm.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/6wp187.jpg")
